...
{/if}
<input type='text' name='{$fields.utm_score_c.name}'
id='{$fields.utm_score_c.name}' size='30'
maxlength='255'        value='{$value}' title=''      >
</div>
...
{/if}
<input type='text' name='{$fields.phone_c.name}'
id='{$fields.phone_c.name}' size='30'
maxlength='255'        value='{$value}' title=''      >
</div>
...
{/if}
<input type='text' name='{$fields.utm_medium_c.name}'
id='{$fields.utm_medium_c.name}' size='30'
maxlength='255'        value='{$value}' title=''      >
</div>
...
{/if}
<input type='text' name='{$fields.phone_number_c.name}'
id='{$fields.phone_number_c.name}' size='30'
maxlength='255'        value='{$value}' title=''      >
</div>
...
{/if}
<input type='text' name='{$fields.utm_campaign_c.name}'
id='{$fields.utm_campaign_c.name}' size='30'
maxlength='255'        value='{$value}' title=''      >
</div>
...
{/if}
<input type='text' name='{$fields.utm_term_c.name}'
id='{$fields.utm_term_c.name}' size='30'
maxlength='255'        value='{$value}' title=''      >
</div>
...
{/if}
<input type='text' name='{$fields.vat_number_c.name}'
id='{$fields.vat_number_c.name}' size='30'
maxlength='255'        value='{$value}' title=''      >
</div>
