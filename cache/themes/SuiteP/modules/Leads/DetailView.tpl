...
{if !$fields.st1_team_leads_1_name.hidden}
{counter name="panelFieldCount" print=false}

{if !empty($fields.st1_team_leads_1st1_team_ida.value)}
{capture assign="detail_url"}index.php?module=ST1_Team&action=DetailView&record={$fields.st1_team_leads_1st1_team_ida.value}{/capture}
<a href="{sugar_ajax_url url=$detail_url}">{/if}
<span id="st1_team_leads_1st1_team_ida" class="sugar_field" data-id-value="{$fields.st1_team_leads_1st1_team_ida.value}">{$fields.st1_team_leads_1_name.value}</span>
{if !empty($fields.st1_team_leads_1st1_team_ida.value)}</a>{/if}
{/if}
