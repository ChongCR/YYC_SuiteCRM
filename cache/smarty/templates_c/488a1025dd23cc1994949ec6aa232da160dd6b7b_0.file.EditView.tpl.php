...
function content_66c46c68e8c5f7_54839571 (Smarty_Internal_Template $_smarty_tpl) {
...
<input type='text' name='<?php echo $_smarty_tpl->tpl_vars['fields']->value['additional_info_c']['name'];?>
'
id='<?php echo $_smarty_tpl->tpl_vars['fields']->value['additional_info_c']['name'];?>
' size='30'
maxlength='255'        value='<?php echo $_smarty_tpl->tpl_vars['value']->value;?>
' title=''      >
</div>
...
' );
addToValidate('EditView', 'utm_campaign_c', 'varchar', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_UTM_CAMPAIGN','module'=>'Leads','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'utm_content_c', 'varchar', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_UTM_CONTENT','module'=>'Leads','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'utm_medium_c', 'varchar', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_UTM_MEDIUM','module'=>'Leads','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'utm_score_c', 'varchar', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_UTM_SCORE','module'=>'Leads','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'utm_term_c', 'varchar', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_UTM_TERM','module'=>'Leads','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'vat_number_c', 'varchar', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_VAT_NUMBER','module'=>'Leads','for_js'=>true),$_smarty_tpl);?>
' );
